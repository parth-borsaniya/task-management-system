...
CREATE TABLE `tasks` (
  ...
  `status` enum('Pending','In Progress','Past Due','Completed') COLLATE utf8mb4_general_ci DEFAULT 'Pending',
  `created_at` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
...
(4, 'Parth', 'parth@gmail.com', '$2y$10$u97ON5tHb6rf4gqvdpdYke8dd5YYK6iJGpaVwz2v3Im5CAl5vZSTm', 'admin', '2025-03-18 21:26:41', NULL);
